...
func on_destroy(
	...
	#TODO: I think we replace this with something on the stats object, that can log stuff from the source
	...
	await cur_controller.combat_cards.move_card(cur_card, CombatCardState.CardTarget.HAND, CombatCardState.CardTarget.VOID)	
